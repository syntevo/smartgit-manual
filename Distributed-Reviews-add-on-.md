...
-   If the Pull Request is fine, you may **Integrate** the Pull Request
    ...
    dialog](Git-Flow.md#Git-Flow-git-flow): you can select
...
Refs](#historic-commit-refs). Only by invoking **Delete** on a *closed*
...
property](System-Properties.md) `smartgit.reviews.integrateMessageTemplate`.
